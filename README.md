...
Here is a workflow diagram of my model, followed by an explanation of how it works:
...
My worship setlist generator returns a setlist to a user's specifications, and after initial, albeit manual, testing, it seems to do a pretty good job recommending appropriate songs. However, much needs to be done for this setlist generator to meet its full potential. Next steps are listed below:
